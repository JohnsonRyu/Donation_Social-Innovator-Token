...
// ----------------------------------------------------------------------------
// @Project Social Innovator Token (SIT)
// @Creator Johnson Ryu (BlockSmith Developer)
// @Source Code Verification ()
// ----------------------------------------------------------------------------
contract SIToken is PausableToken, MintableToken, BurnableToken, MultiTransferToken {
    string public name = "Social Innovator Token";
